...
var spawnServerForCert = function spawnServerForCert() {
	return new Promise(function (resolve, reject) {
		var cwd = (0, _persistPath2.default)('preact-cli');
		var child = (0, _child_process.execFile)(_simplehttp2server2.default, ['-listen', ':40210'], {
			cwd,
			encoding: 'utf8'
